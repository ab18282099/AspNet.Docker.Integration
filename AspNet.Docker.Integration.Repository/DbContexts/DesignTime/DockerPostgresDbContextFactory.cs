...
namespace AspNet.Docker.Integration.Repository
{
    ...
    /// </summary>
    public class DockerPostgresDbContextFactory : DesignTimeDbContextFactoryBase<DockPostgresDbContext>
    {
        /// <summary>
        /// 連線字串鍵值
        /// </summary>
        ...
        protected override DockPostgresDbContext CreateNewInstance(DbContextOptionsBuilder<DockPostgresDbContext> optionsBuilder, string connectionString)
        {
            // 設定使用 Npgsql 為 DbProvider
            optionsBuilder.UseNpgsql(connectionString);

            return new DockPostgresDbContext(optionsBuilder.Options);
        }
    }
}